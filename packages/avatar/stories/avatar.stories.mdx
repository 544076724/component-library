...
export const Template  = (args) => ({
  ...
  template: `
    <div style="width:40px;height:40px">
      <c-dhn-avatar v-bind="args" @error="errorHandler">
...
<template>
   <div style="width:40px;height:40px">
      <c-dhn-avatar :src="src" size="small"></c-dhn-avatar>
    </div>
    <div style="width:40px;height:40px">
      <c-dhn-avatar :src="src" size="medium"></c-dhn-avatar>
    </div>
    <div style="width:40px;height:40px">
      <c-dhn-avatar :src="src" size="large"></c-dhn-avatar>
    </div>
    <div style="width:40px;height:40px">
      <c-dhn-avatar :src="src" size="large" shape="square"></c-dhn-avatar>
    </div>
    <c-dhn-avatar :src="src" :size="70" :shape="'square'"></c-dhn-avatar>
</template>
<script>
  export default {
    data () {
